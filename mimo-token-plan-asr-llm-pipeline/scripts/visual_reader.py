...
.chapter-band{{display:grid;grid-template-columns:minmax(260px,.78fr) minmax(0,1.22fr);gap:48px;padding:72px 0;border-top:1px solid var(--color-line)}}.chapter-band:nth-of-type(2n+3){{color:#fff;background:var(--color-secondary);box-shadow:0 0 0 100vmax var(--color-secondary);clip-path:inset(0 -100vmax)}}.chapter-band:nth-of-type(2n+3) .chapter-index{{color:#FFE1B0}}.chapter-band:nth-of-type(2n+3) .chapter-summary{{color:#FFF8EE}}.chapter-band:nth-of-type(2n+3) .source-tags li{{background:rgba(17,24,39,.24);color:#fff}}.chapter-band:nth-of-type(2n+3) .source-tags span{{color:#FFE1B0}}.chapter-copy h2{{font:800 clamp(2rem,4vw,3rem)/1.05 var(--font-display);letter-spacing:-.03em;text-wrap:balance;margin:12px 0 20px}}.chapter-summary{{margin:0;color:var(--color-muted)}}
.source-tags{{list-style:none;padding:0;margin:24px 0 0;display:flex;flex-wrap:wrap;gap:8px}}.source-tags li{{font:600 12px/1.4 var(--font-mono);background:rgba(255,255,255,.58);border:1px solid currentColor;padding:7px 10px}}.source-tags span{{color:var(--color-secondary-strong);font-weight:800;margin-right:7px}}
.chapter-graphics{{display:grid;gap:20px}}.editorial-visual{{margin:0;background:var(--color-surface);color:var(--color-text);padding:24px;border:1px solid var(--color-line);border-top:6px solid var(--color-primary);box-shadow:var(--shadow-card)}}figcaption{{font:700 1.08rem/1.4 var(--font-display);margin-bottom:18px}}.diagram-accent{{display:block;width:120px;height:12px;margin-bottom:20px;fill:none;stroke:var(--color-secondary);stroke-width:2}}
...
.editorial-text-treatment{{padding:24px;border-left:6px solid var(--color-primary);background:var(--color-surface);color:var(--color-text);box-shadow:var(--shadow-card)}}footer{{padding:40px 0 64px;border-top:1px solid var(--color-line);font:600 12px/1.5 var(--font-mono);color:var(--color-muted);letter-spacing:.04em}}
@media(max-width:760px){{body{{font-size:16px}}.compact-editorial{{padding:0 18px}}.page-header{{padding:64px 0 42px}}.page-header:after{{top:24px}}h1{{font-size:clamp(2.7rem,15vw,4.2rem);overflow-wrap:anywhere}}.insight-grid,.chapter-band{{grid-template-columns:1fr}}.chapter-band{{gap:28px;padding:48px 0}}.comparison-diagram{{grid-template-columns:1fr}}.editorial-visual{{padding:20px}}}}
@media(hover:none){{.insight-grid li:hover{{transform:none;box-shadow:var(--shadow-card)}}}}@media(prefers-reduced-motion:reduce){{html{{scroll-behavior:auto}}*,*:before,*:after{{scroll-behavior:auto!important;transition:none!important}}}}@media print{{body{{background:#fff;background-image:none}}.compact-editorial{{max-width:none}}.chapter-band:nth-of-type(2n+3){{color:var(--color-text);background:#fff;box-shadow:none;clip-path:none}}.chapter-band:nth-of-type(2n+3) .chapter-summary{{color:var(--color-muted)}}}}
